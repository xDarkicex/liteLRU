...
\begin{itemize}
    ...
    \item \textbf{No Set Associative Arrays}: Replaced the lock-free 64-way set associative architecture with a standard Go \texttt{map} protected by a \texttt{sync.RWMutex}.
\end{itemize}
...
\texttt{liteLRU} & \textbf{93,603} & \textbf{276 $\mu$s} & \textbf{1.20 ms} & \textbf{31.9 ms} \\ \bottomrule
\end{tabular}
